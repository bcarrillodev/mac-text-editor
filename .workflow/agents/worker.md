...
3. Modify ONLY the files explicitly listed in `allowed_files` from the data contract
4. Output the exact file paths and the full replacement code for the files you modified

## Output
- Minimum viable code to satisfy instructions and pass lint/typecheck/tests/coverage gates
